  ...
  return (
    <div className="w-full">
      <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-default-500 mb-2">{t("interviewType")}</p>
          ...
          <div>
            ...
            {selectedTimeSlotRange.length > 1 && (
              <p className="text-xs text-default-400 mt-1">
                Duration: {selectedTimeSlotRange[0].label} - {selectedTimeSlotRange[1].label}
              </p>
            )}
          </div>
          ...
          {selectedResume && (
            <>
              <div>
                <p className="text-sm text-default-500 mb-2">{t("relatedResume")}</p>
                <div className="flex items-center gap-2">
                  <FileText size={18} />
